 function [mAB,fAB,Feff,kAB1,kAB2,ZAB,tAB]=probBi(qp,qm,setC,pi,Q,setA,setB,n,N,Case,filepath)
...
fname= sprintf('Fig_31_Case_%d.png',Case);
...
fname= sprintf('Fig_32_Case_%d.png',Case);
saveas(h, fullfile(filepath,fname));
